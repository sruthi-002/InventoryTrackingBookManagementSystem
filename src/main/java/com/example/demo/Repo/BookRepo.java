...
public interface BookRepo extends JpaRepository<Book,Integer>{
	@Query(value="SELECT * FROM InventoryTrackingSystem as b WHERE (b.title like '%?:keyword%' OR b.author like'%:keyword%' OR b.id like '%:keyword%') AND b.category like '%:category%",nativeQuery=true)
